#ifndef HNtypeI_HighPt_FakeRate_h
#define HNtypeI_HighPt_FakeRate_h

#include "HNAnalyzerCore.h"

class HNtypeI_HighPt_FakeRate : public HNAnalyzerCore {
