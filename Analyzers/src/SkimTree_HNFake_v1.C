#include "SkimTree_HNFake_v1.h"

void SkimTree_HNFake_v1::initializeAnalyzer(){

  outfile->cd();
  cout << "[SkimTree_HNFake_v1::initializeAnalyzer()] gDirectory = " << gDirectory->GetName() << endl;
  ...
  if(DataYear==2016){
    ...
    cout<<"[SkimTree_HNFake_v1::initializeAnalyzer] DataYear is wrong : " << DataYear << endl;
  }

  cout << "[SkimTree_HNFake_v1::initializeAnalyzer] triggers to skim = " << endl;
  for(unsigned int i=0; i<triggers.size(); i++){
    cout << "[SkimTree_HNFake_v1::initializeAnalyzer]   " << triggers.at(i) << endl;
  }

}

void SkimTree_HNFake_v1::executeEvent(){
...
void SkimTree_HNFake_v1::executeEventFromParameter(AnalyzerParameter param){

}

SkimTree_HNFake_v1::SkimTree_HNFake_v1(){
  newtree=NULL;
}
...
void SkimTree_HNFake_v1::WriteHist(){
