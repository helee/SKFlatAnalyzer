#include "HNtypeI_PromptRate_2016H.h"

HNtypeI_PromptRate_2016H::HNtypeI_PromptRate_2016H(){

}

void HNtypeI_PromptRate_2016H::initializeAnalyzer(){
  ...
  cout << "[HNtypeI_PromptRate_2016H::initializeAnalyzer] RunSyst = " << RunSyst << endl;
  //cout << "[HNtypeI_PromptRate_2016H::initializeAnalyzer] RunMET = " << RunMET << endl;
  cout << "[HNtypeI_PromptRate_2016H::initializeAnalyzer] RunFake = " << RunFake << endl;
  ...
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/HNtypeI_PromptRate_2016H.h 
  ...
  //cout << "[HNtypeI_PromptRate_2016H::initializeAnalyzer] IsoMuTriggerName = " << IsoMuTriggerName << endl;
  //cout << "[HNtypeI_PromptRate_2016H::initializeAnalyzer TriggerSafePtCut = " << TriggerSafePtCut << endl;
...
void HNtypeI_PromptRate_2016H::executeEvent(){
  ...
  //==== So, I defined "vector<Muon> AllMuons;" in Analyzers/include/HNtypeI_PromptRate_2016H.h,
  ...
  //==== I defined "double weight_Prefire;" in Analyzers/include/HNtypeI_PromptRate_2016H.h
...
void HNtypeI_PromptRate_2016H::executeEventFromParameter(AnalyzerParameter param){
  ...
  if(param.syst_ == AnalyzerParameter::Central){
    ...
    cout << "[HNtypeI_PromptRate_2016H::executeEventFromParameter] Wrong syst" << endl;
    exit(EXIT_FAILURE);
  }
